  ...
  1: [function (require, module, exports) {
    function MyDealer() {
      ...
      function getMyDealer() {
        ...
        preferredSet ? $brand = '' : $html.is('[data-brand]') && ($brand = $html.attr('data-brand'), $brand = `-${$brand}`);
        const dealer = {
          dealer: '',
          dealerName: '',
          dealerCity: '',
    ...
    MyDealer = new MyDealer(), MyDealer.init();
  }, {}],
}, {}, [1]));
