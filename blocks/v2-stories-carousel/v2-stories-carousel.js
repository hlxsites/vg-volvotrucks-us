...
const buildStoryCard = (entry) => {
  ...
  const svgClock = `<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  const svgCalendar = `<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  const svgUser = `<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  const card = document.createRange().createContextualFragment(`
    ...
    <div class="v2-stories-carousel-text">
      ...
      <a href="${path}" class="v2-stories-carousel-cta button primary">
        ${readMore}
        ${svgArrowRight}
      </a>
    </div>`);
